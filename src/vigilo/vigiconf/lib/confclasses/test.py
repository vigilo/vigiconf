...
class Test(object):
    ...
    @ivar weight: The weight of all services generated by this test
        when they are in the OK state. Defaults to 1.
    @type weight: C{int}
    @ivar warning_weight: The weight of all services generated by this test
        when they are in the WARNING state.
        Defaults to the same value as L{weight}.
