...
setup(name='vigilo-vigiconf',
        ...
        entry_points={
            ...
            'vigilo.vigiconf.generators': [
                'collector = vigilo.vigiconf.generators.collector:CollectorTpl',
                'connector_metro = vigilo.vigiconf.generators.connector_metro:ConnectorMetroTpl',
                'corrtrap = vigilo.vigiconf.generators.corrtrap:CorrTrapTpl',
                'nagios = vigilo.vigiconf.generators.nagios:NagiosTpl',
                'nagios_hls = vigilo.vigiconf.generators.nagios_hls:NagiosHlsTpl',
                'perfdata = vigilo.vigiconf.generators.perfdata:PerfDataTpl',
                'rrdgraph = vigilo.vigiconf.generators.rrdgraph:RRDgraphTpl',
                'group_maps = vigilo.vigiconf.generators.groups_maps:GroupsMaps',
                'vigiconf_local = vigilo.vigiconf.generators.vigiconf_local:VigiConfLocal',
                ],
            },
        package_dir={'': 'src'},
